...
{
    public class CreateFinishedProductPalletCommandValidator : AbstractValidator<CreateFinishedProductPalletCommand>
    {
        public CreateFinishedProductPalletCommandValidator()
        {
